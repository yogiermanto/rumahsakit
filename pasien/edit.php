            ...
            <div class="col-lg-6 col-lg-offset-3">
              ...
              ?>
                <form action="proses.php" method="post">
                    ...
                    <!-- Membuat radio button jenis kelamin -->
                    <div class="form-group">
                    <label for="alamat">Jenis Kelamin</label> 
                        <div>
                          <label for="" class="radio-inline">
                            <!-- jika jenis_kelamin == L maka checked 
                                  ? adalah else, jika tidak/else null. -->
                    ...
                    <label for="tep">No. Telepon</label>  
                        <input type="number" name="telp" id="telp" class="form-control" value="<?=$data['no_telp']?>" required></textarea>
                    </div>
